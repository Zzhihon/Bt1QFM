  ...
  return (
    <nav className="bg-cyber-bg-darker p-4 shadow-lg border-b-2 border-cyber-primary">
      <div className="container mx-auto flex justify-between items-center">
        ...
        >
          <Music className="mr-2 h-8 w-8" /> 1QFM
        </button>
          ...
          {currentUser ? (
            <>
              <button 
                ...
                className="text-cyber-secondary hover:text-cyber-accent px-3 py-2 rounded-md text-sm font-medium transition-colors duration-300 flex items-center"
              >
